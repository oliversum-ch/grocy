...
$hasLegacyTrigger = $db->ExecuteDbQuery("SELECT COUNT(*) FROM sqlite_master WHERE type = 'trigger' AND name = 'products_default_qu_conversions'")->fetchColumn() > 0;

if ($hasLegacyTrigger)
{
	$db->ExecuteDbStatement("DROP TRIGGER products_default_qu_conversions;
