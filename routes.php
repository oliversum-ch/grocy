...
use Grocy\Controllers\ReceiptImportApiController;
use Grocy\Controllers\ReceiptImportController;
...
$app->group('', function (RouteCollectorProxy $group)
{
	...
	$group->get('/receiptimport', [ReceiptImportController::class, 'Overview']);
...
$app->group('/api', function (RouteCollectorProxy $group)
{
	...
	$group->post('/receipt-import/preview', [ReceiptImportApiController::class, 'Preview']);
	$group->post('/receipt-import/commit', [ReceiptImportApiController::class, 'Commit']);
	$group->post('/receipt-import/{receiptImportId}/undo', [ReceiptImportApiController::class, 'Undo']);
	$group->get('/receipt-import/history', [ReceiptImportApiController::class, 'History']);
	$group->get('/receipt-import/products', [ReceiptImportApiController::class, 'Products']);
